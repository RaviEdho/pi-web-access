...
function baseOptions(timeout = 1) {
	return {
		...
		timeout,
		availableProviders: { all: true, openai: false, brave: false, parallel: false, tinyfish: false, search1api: false, searchinfinity: false, tavily: false, serpdive: false, searxng: false, perplexity: false, exa: true, gemini: false, anysearch: false },
		defaultProvider: "exa",
		searchProvider: "exa",
		summaryModels: [],
